  ...
  const steps = [
    {
      ...
      description:
        "Share your CRM data in CSV along with a description of your Ideal Customer Profile (ICP) and the specific client information you want to enrich.",
      number: "01",
    },
    {
      ...
      description:
        "We process and clean your data, enriching it with valuable external insights to improve its accuracy and completeness.",
      number: "02",
    },
    {
      ...
      description:
        "Receive a refined list of potential leads, complete with accurate and up-to-date information, ready for your sales team to act on.",
      number: "03",
    },
  ];
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative mt-8">
          {steps.map((step, index) => (
            <div
              key={index}
              className="process-card relative flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-gray-100"
            >
