  ...
  return <section id="how-it-works" className="w-full py-12 md:py-24 bg-brand-light/30">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
          ...
          <p className="max-w-[600px] text-gray-500 dark:text-gray-400 font-normal md:text-xl text-center">Set up AI enrichment in minutes — just tell us about your Ideal Customer Profile, and we'll do the rest.
